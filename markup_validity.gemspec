...
Gem::Specification.new do |s|
  s.name = 'camelpunch-markup_validity'
  s.version = "1.1.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Aaron Patterson", "Andrew Bruce"]
  s.date = %q{2010-03-09}
  ...
  s.email = ["aaronp@rubyforge.org", "andrew@camelpunch.com"]
  ...
  s.has_rdoc = true
  s.homepage = %q{http://github.com/camelpunch/markup_validity}
